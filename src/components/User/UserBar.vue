    ...
    <div id="user-bar">
        ...
        <div class="func-btn-wrap flex-center">
            <div class="func-btn flex-center" @click="getApplies">
                ...
                <div class="pot" v-if="userStore.appliesCount">
                    <span>{{ userStore.appliesCount > 99 ? '99+' : userStore.appliesCount }}</span>
                </div>
            </div>

            <div class="func-btn flex-center" @click="openSetting">
        ...
        <!-- 申请列表面板 -->
        <ApplyListPanel v-model:show="showApplyListPanel"></ApplyListPanel>
    </div>
</template>
<script lang="ts" setup>
import { ref } from 'vue'
import UserDetail from '@/components/User/UserDetail.vue'
import ApplyListPanel from '@/components/Apply/ApplyListPanel.vue';
...
const 
    showApplyListPanel = ref(false),
    showUserDetail = ref(false)

// 获取申请信息列表
function getApplies(){
    showApplyListPanel.value = true;
}
    ...
    .func-btn-wrap{
        .func-btn{
            ...
            .pot{
                ...
                align-items: center;
                span{ line-height: 1;transform: scale(.5); }
            }
        }
    }

<template>
    <div class="center-container">
        <div class="form-wrap">
            ...
            <form method="post" name="login-form" v-show="formType === 0" @submit.prevent="toLogin">
            ...
            <form method="post" name="reg-form" v-show="formType === 1" @submit.prevent="toRegister">
                ...
                <a class="link tologin" @click="formType=0">已有账户？</a>
            </form>
        </div>
    </div>
...
(inject('piniaInstance') as Pinia).state.value = {}
...
// 注册用户
function toRegister(){
    userRegister(regData).then((resp) => {
        if (resp.code == 200) {
